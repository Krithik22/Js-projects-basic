...
// qazi.attackDmg 👉 7
class Player {
  constructor(name, health, maxDamage) {
    this.name = name;
    this.health = health;
  ...
  heal (player) {
    ...
    //  Update the game and DOM with updateGame()
    updateGame(player,player2,gameState)
...
let player1 = new Player('Kohli',100,10)
let player2 = new Player('Anderson',100,9)
...
document.addEventListener('keydown', function(e) {
  // if you press Q AND the enemy health is greater than 0 AND isOver is still false then strike()
    if(e.key == 'q' && p2.health > 0 && !isOver){
        ...
        console.log(p1.strike(p1,p2,p1.maxDamage))
